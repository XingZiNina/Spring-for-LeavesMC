...
public class PluginMessageHandler
{
    ...
    public final String pluginChannel = "distant_horizons:msg";

    public final short protocolVersion = 13;
    ...
    public void onPluginMessageReceived(@NotNull String channel, @NotNull UUID senderUuid, byte[] data)
    {
        ...
        if (message instanceof CloseReasonMessage) {
            throw new RuntimeException(((CloseReasonMessage) message).getReason());
        }
