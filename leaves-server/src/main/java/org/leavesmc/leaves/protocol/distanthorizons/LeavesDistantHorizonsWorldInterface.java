...
public class LeavesDistantHorizonsWorldInterface implements WorldInterface
{
    ...
    public LeavesDistantHorizonsWorldInterface(DhSupport dhSupport, World world, Configuration config)
    {
        ...
        this.lightOffset = this.getConfig().getInt(DhsConfig.LIGHT_OFFSET_HACK, 0);
    ...
    {
        LeavesDistantHorizonsWorldInterface newInstance = new LeavesDistantHorizonsWorldInterface(this.dhSupport, this.world, this.config);
    ...
    protected ChunkSnapshot getChunk(int x, int z)
    {
        ...
        Scheduler scheduler = this.dhSupport.getScheduler();
    ...
    public CompletableFuture<Boolean> loadChunkAsync(int x, int z)
    {
        ...
        if (this.getChunkAtAsync == null) {
            return this.dhSupport.getScheduler().runOnMainThread(() -> this.loadChunk(x, z));
        }
    ...
    public CompletableFuture<Boolean> loadOrGenerateChunkAsync(int x, int z)
    {
        ...
        if (this.getChunkAtAsync == null) {
            return this.dhSupport.getScheduler().runOnMainThread(() -> this.loadOrGenerateChunk(x, z));
        }
    ...
    public boolean isBeacon(int x, int y, int z)
    {
        ...
        return this.dhSupport.getScheduler()
