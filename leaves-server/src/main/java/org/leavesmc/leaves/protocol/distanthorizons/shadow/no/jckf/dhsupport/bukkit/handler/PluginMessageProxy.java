...
import org.leavesmc.leaves.protocol.distanthorizons.shadow.no.jckf.dhsupport.bukkit.BukkitPluginMessageSender;
import org.leavesmc.leaves.protocol.distanthorizons.shadow.no.jckf.dhsupport.bukkit.DhSupportBukkitPlugin;
import org.leavesmc.leaves.protocol.distanthorizons.shadow.no.jckf.dhsupport.core.handler.PluginMessageHandler;
...
public class PluginMessageProxy extends Handler implements PluginMessageListener
{
    ...
    public void onPluginMessageReceived(@NotNull String channel, @NotNull Player player, byte[] message)
    {
        try {
            ...
            player.sendMessage(ChatColor.RED + "Distant Horizons: " + exception.getMessage());
        }
    }
}
